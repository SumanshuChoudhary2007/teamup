...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20 relative">
      ...
      <div className="fixed top-[10%] right-[20%] w-[400px] h-[400px] rounded-full blur-[100px] pointer-events-none bg-[#7c3aed]/10" />
      <div className="fixed bottom-[10%] left-[10%] w-[300px] h-[300px] rounded-full blur-[100px] pointer-events-none bg-[#06b6d4]/10" />
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        ...
        <div className="glass rounded-2xl p-8 border border-white/5">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 flex items-center justify-center gap-2 text-base font-bold rounded-xl transition-all shadow-xl gradient-bg text-white hover:opacity-90 shadow-[#7c3aed]/20"
            >
              {loading ? (
        ...
        <p className="text-center mt-6 text-sm text-[#94a3b8]">
          ...
          <Link href={`/register${redirect ? `?redirect=${redirect}` : ''}`} className="text-[#a78bfa] hover:text-white font-medium inline-flex items-center gap-1">
